migrate((app) => {
  ...
  const collection = new Collection({
    ...
    indexes: [
      ...
      "CREATE INDEX idx_category_prefs_provider ON category_prefs (provider)",
      "CREATE UNIQUE INDEX idx_category_prefs_unique ON category_prefs (user, provider, type, category_id)",
    ],
  });
